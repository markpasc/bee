...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('bee_post', 'published', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.utcnow), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.published'
        db.delete_column('bee_post', 'published')
