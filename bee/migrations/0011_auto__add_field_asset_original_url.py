...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Asset.original_url'
        db.add_column('bee_asset', 'original_url', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Asset.original_url'
        db.delete_column('bee_asset', 'original_url')
