...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TrustGroup.user'
        db.alter_column('bee_trustgroup', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'TrustGroup.user'
        db.alter_column('bee_trustgroup', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
