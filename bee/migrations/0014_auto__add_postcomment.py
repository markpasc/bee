...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bee_postcomment', (
            ('comment_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['comments.Comment'], unique=True, primary_key=True)),
            ('atom_id', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True)),
            ('avatar', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bee.Avatar'], null=True, blank=True)),
        ))
        db.send_create_signal('bee', ['PostComment'])


    def backwards(self, orm):
        
        # Deleting model 'PostComment'
        db.delete_table('bee_postcomment')
