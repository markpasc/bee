...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PostComment.in_reply_to'
        db.add_column('bee_postcomment', 'in_reply_to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bee.PostComment'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PostComment.in_reply_to'
        db.delete_column('bee_postcomment', 'in_reply_to_id')
