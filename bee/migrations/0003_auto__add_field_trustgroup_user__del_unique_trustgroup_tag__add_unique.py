...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'TrustGroup', fields ['tag']
        db.delete_unique('bee_trustgroup', ['tag'])

        # Adding field 'TrustGroup.user'
        db.add_column('bee_trustgroup', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Adding unique constraint on 'TrustGroup', fields ['tag', 'user']
        db.create_unique('bee_trustgroup', ['tag', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'TrustGroup', fields ['tag', 'user']
        db.delete_unique('bee_trustgroup', ['tag', 'user_id'])

        # Deleting field 'TrustGroup.user'
        db.delete_column('bee_trustgroup', 'user_id')

        # Adding unique constraint on 'TrustGroup', fields ['tag']
        db.create_unique('bee_trustgroup', ['tag'])
