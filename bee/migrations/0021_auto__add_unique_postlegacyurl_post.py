...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'PostLegacyUrl', fields ['post']
        db.create_unique('bee_postlegacyurl', ['post_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PostLegacyUrl', fields ['post']
        db.delete_unique('bee_postlegacyurl', ['post_id'])
    ...
    models = {
        ...
        'bee.postlegacyurl': {
            ...
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bee.Post']", 'unique': 'True'})
        },
        'bee.template': {
