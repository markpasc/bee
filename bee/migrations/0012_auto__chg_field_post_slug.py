...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('bee_post', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=80))


    def backwards(self, orm):
        
        # Changing field 'Post.slug'
        db.alter_column('bee_post', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
