...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.comments_enabled'
        db.add_column('bee_post', 'comments_enabled', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.comments_enabled'
        db.delete_column('bee_post', 'comments_enabled')
